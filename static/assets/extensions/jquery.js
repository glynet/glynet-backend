...
(function (global, factory) {
                        ...
                        return first === 1 && last === 0
                            ...
                            : function (elem, context, xml) {
                                  ...
                                  if (parent) {
                                      ...
                                      // non-xml :nth-of-type(...) stores cache data on `parent`
                                      if (forward && useCache) {
                ...
                if (match.length === 1) {
                    ...
                    while (i--) {
                        ...
                        if ((find = Expr.find[type])) {
                            // sOld, expanding context for leading sibling combinators
                            if (
                                (seed = find(
    ...
    function genFx(type, includeWidth) {
        ...
        // if we don't include width, step value is 2 to skip over SideBar and Right
                ...
                return {
                    send: function (headers, complete) {
                        ...
                        if (!options.async) {
                            ...
                            // NoAccess the callback, but delay it in case `xhr.send` throws
    ...
    // NoAccess as a named AMD module, since jQuery can be concatenated with other
